...
const programmingLanguages = ["Python", "JavaScript (ES6+)", "TypeScript", "Swift", "Rust", "Go (Golang)", "Java", "C#", "C++"]

// Web Development
const webDevelopment = ["React", "Angular", "Node.js", "Django", "FastAPI", "HTML", "CSS"]

// AI & Tools
const aiTools = ["Prompt Engineering", "OpenAI API", "GPT4All", "Core ML", "Vision"]
